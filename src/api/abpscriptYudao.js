import abpYudaoInstance from '@/utils/requestAbpYudao' // 引入 abp 的 Axios 实例

// 获取员工头像
export function getEmployeeAvatar(data) {
  console.log('请求参数:', data); // 打印请求参数

  return abpYudaoInstance.post('/api/abpscript/avator', { // 使用相对路径
    data: {
      emp_id: data.empId
    }
  }).then(response => {
...
export function getSbuList() {
  return abpYudaoInstance.get('/api/abpscript/getSbuList')
    .then(response => {
...
export function getVideoTemplateBySbu(sbu) {
  ...
  return abpYudaoInstance.post('/api/abpscript/getVideoTemplateBySbu', {
    data: {
      sbu: sbu, // 传递的参数
    },
  })
...
export function getAbpTemplateVideo(data) {
  console.log('请求参数:', data); // 打印请求参数
  return abpYudaoInstance.post('/api/abpscript/getAbpTemplateVideo', {
    data: {
      emp_id: data.empId,
    },
  }).then(response => {
...
export function getAbpCompositeVideo(data) {
  console.log('请求参数:', data); // 打印请求参数
  return abpYudaoInstance.post('/api/abpscript/getAbpCompositeVideo', {
    data: {
      emp_id: data.empId,
    },
  }).then(response => {
...
export function getCompositeSameVideo(data) {
  ...
  return abpYudaoInstance.post('/api/abpscript/getCompositeSameVideo', {
    data: {
      emp_id: data.empId,
    },
  }).then(response => {
...
export function getAbpUserTone(data) {
  console.log('请求参数:', data); // 打印请求参数
  return abpYudaoInstance.post('/api/abpscript/getAbpUserTone', {
    data: {
      emp_id: data.empId,
    },
  }).then(response => {
...
export const getOralVideo = (data) => {
  ...
  return abpYudaoInstance.post('/api/abpscript/getOralVideo', data)
    .then(response => {
      console.log('响应结果:', response); // 打印响应结果
      return response.data;
    })
...
export const fetchMaterialIdByModel = (data = {}) => {
  ...
  return abpYudaoInstance.post('/api/abpscript/ProductMaterial', data)
    .then(response => {
      console.log('响应结果:', response); // 打印响应结果
      return response.data;
    })
...
export const fetchProduct3DImage = (data = {}) => {
  ...
  return abpYudaoInstance.post('/api/abpscript/Product3D', data)
    .then(response => {
      console.log('响应结果:', response); // 打印响应结果
      return response.data;
    })
...
export const getOralScript = (data) => {
  ...
  return abpYudaoInstance.post('/api/abpscript/getOralScript', data)
    .then(response => {
      console.log('响应结果:', response); // 打印响应结果
      return response.data;
    })
...
export const fetchSBUTreeSort = () => {
  ...
  return abpYudaoInstance.get('/api/abpscript/SBUTree')
    .then(response => {
      console.log('响应结果:', response); // 打印响应结果
      return response.data;
    })
...
export const fetchSimilarModelBySBU = (data) => {
  ...
  return abpYudaoInstance.post('/api/abpscript/SimilarModel', data)
    .then(response => {
      console.log('响应结果:', response); // 打印响应结果
      return response.data;
    })
...
export const deleteCompositeSameVideo = (data) => {
  ...
  return abpYudaoInstance.post('/api/abpscript/deleteCompositeSameVideo', data)
    .then(response => {
      console.log('响应结果:', response); // 打印响应结果
      return response.data;
    })
...
export const getDownloadCosFileUrl = (data) => {
  ...
  return abpYudaoInstance.post('/api/abpscript/getDownloadCosFileUrl', data)
    .then(response => {
      console.log('响应结果:', response); // 打印响应结果
      return response.data;
    })
